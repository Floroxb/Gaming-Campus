...
def play():
    ...
    while turn != 3:
        ...
        turn = turn + 1
    #On delimite la zone de score
    print("---------------------------------------------------------------")
    #On renvoie le nombre de fois que on a gagné
    print( "Vous avez gagné : " + str(win) + ' fois' )
    #On renvoie le nombre de fois que on a egalisé
    print( "Vous avez égalisé : " + str(draw) + ' fois' )
    #On renvoie le nombre de fois que on a perdu
    print( "Vous avez perdu : " + str(lose) + ' fois' )
    
#on execute la fonction play
play()